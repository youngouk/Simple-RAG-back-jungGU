...
class ConfigLoader:
    ...
    def _apply_env_overrides(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        env_mappings = {
            'PORT': ('server', 'port'),
            'HOST': ('server', 'host'),
            'GOOGLE_API_KEY': ('models', 'llm', 'providers', 'gemini', 'api_key'),
            'OPENAI_API_KEY': ('models', 'llm', 'providers', 'openai', 'api_key'),
            'CLAUDE_API_KEY': ('models', 'llm', 'providers', 'claude', 'api_key'),
            'COHERE_API_KEY': ('models', 'reranker', 'providers', 'cohere', 'api_key'),
